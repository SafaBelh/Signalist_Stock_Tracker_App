...
export default function WatchlistTable({ watchlist }: WatchlistTableProps) {
  ...
  const handleAddAlert = (stock: WatchlistTableProps["watchlist"][0]) => {
  ...
  return (
    <div className="overflow-x-auto rounded-lg shadow-lg border border-[#2a2a2a]">
      <Table className="w-full border-collapse border border-[#2a2a2a] text-left align-middle">
        <TableHeader className="bg-[#222328] text-gray-300 text-[15px] font-bold text-left [&_th]:font-[600] [&_th]:text-gray-300">
            ...
            >
              ...
              <TableCell className="px-4 py-1 border border-[#2a2a2a]">
                <button 
                  ...
                  className="bg-[#a27ff1] hover:bg-[#a17ff156] text-white px-2 py-1 rounded-[5px] text-[13px] font-[600] transition-colors cursor-pointer"
                >
                  Add Alert
                </button>
              </TableCell>
